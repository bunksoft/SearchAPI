...
def _get_allowed_data(data_type):
    logpoints=["127.0.0.1"]
    url = "%s://%s/%s" % ('https', '192.168.2.205', "getalloweddata")

    data = {
            "username":'bunkdeath',
            "secret_key": 'bcb070c22969225e0f517b403391bcde',
            "type": data_type,
    ...
    return json.loads(ack.content)

print _get_allowed_data("logpoint_repos")